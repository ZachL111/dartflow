...
`dartflow` is centered on mobile workflows work in Dart. The technical target is: Model offline form queues, validation, retries, and merge outcomes.
...
The score is deterministic. The current threshold is 162. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 4.
