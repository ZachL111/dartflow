"""Regression checks for the dartflow casebook."""
...
from casebook.harness import assert_expected, dartflow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(dartflow_summary(), assert_expected())
