...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-dartflow-detail.ps1

dart tests/test_domain_review.dart

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-dartflow-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-dartflow-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-dartflow-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
