...
dartflow is a Dart project for mobile workflows. It focuses on this technical goal: Model offline form queues, validation, retries, and merge outcomes.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 162, risk penalty 5, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
